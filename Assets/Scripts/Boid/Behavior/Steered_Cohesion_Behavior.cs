...
public class Steered_Cohesion_Behavior : Filtered_Flock_Behavior
{
    ...
    public override Vector2 CalculateMove(Flock_Agent agent, List<Transform> context, Flock flock)
    {
        ...
        cohesionMove = Vector2.SmoothDamp(agent.transform.up, cohesionMove, ref _currentVelocity, _agentSmoothTime);
        return cohesionMove;
    }
}
